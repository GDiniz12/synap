...
export const translations = {
  'pt-BR': {
    ...
    desc_general: 'Personalize o idioma e o comportamento do Tesseract.',
  ...
  'en-US': {
    ...
    desc_general: 'Customize language and Tesseract startup behavior.',
