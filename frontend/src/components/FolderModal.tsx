      ...
      >
        <div className="p-6 flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-none bg-white/5 text-white border border-white/10 flex items-center justify-center shrink-0">
              <svg
                width="18"
                height="18"
                viewBox="0 0 24 24"
          ...
          <form id="folder-modal-form" onSubmit={handleSubmit} className="flex flex-col gap-3">
            <div>
              <label
                ...
                className="block text-[11px] font-mono font-semibold uppercase tracking-wider text-zinc-400 mb-1.5"
              >
                Nome da Pasta
              </label>
              <input
        ...
        <div className="bg-[#141414] border-t border-white/10 px-6 py-3.5 flex items-center justify-end gap-2.5">
          ...
          <button
            ...
            className="h-8 px-5 text-xs font-bold rounded-none bg-white text-black hover:bg-zinc-200 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
          >
