...
function RegisterForm() {
  ...
  return (
    <div className="w-full max-w-[380px] bg-[#181818] border border-white/10 rounded-none shadow-2xl p-6 sm:p-7 flex flex-col font-sansation relative my-auto">
      ...
      <form onSubmit={handleRegister} className="flex flex-col gap-3">
        ...
        <div>
          ...
          <div className="relative flex items-center">
            <span className="absolute left-3 text-zinc-500 font-mono text-xs select-none pointer-events-none">
              @
            </span>
            <input
              type="text"
              ...
              placeholder="usuario"
              required
              className="w-full h-9 pl-7 pr-9 text-xs bg-[#121212] border border-white/10 focus:border-white/40 rounded-none outline-none text-white placeholder-zinc-600 transition-colors font-sansation"
            />
            {isUsernameValid && (
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="absolute right-3 text-emerald-400">
      ...
      {/* Legal Disclaimer */}
      <p className="text-[10px] text-zinc-500 text-center leading-tight mt-3 pt-3 border-t border-white/5">
        Ao se registrar, você concorda com os Termos de Serviço e a Política de Privacidade do Tesseract.
      </p>
    </div>
  );
}
